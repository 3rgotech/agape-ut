...
return [
    ...
    'settings' => [
        ...
        'fields' => [
            'notificationsToAdmins'             => 'Envoyer les notifications aux administrateurs',
            'notificationsToManagers'           => 'Envoyer les notifications aux gestionnaires',
            'notificationsToProjectCallCreator' => 'Envoyer les notifications au créateur de l\'appel à projets',
            'notificationsCc'                   => 'Envoyer toutes les notifications en copie aux adresses suivantes (séparées par des virgules)',
            'notificationsBcc'                  => 'Envoyer toutes les notifications en copie cachée aux adresses suivantes (séparées par des virgules)',
