...
return [
    ...
    'managing_structure_is_lab' => 'La structure destinataire est-elle un laboratoire ?',
    ...
    'dynamic_attributes' => [
        ...
        'option_multiple'    => 'Choix multiple ?',
        'choices'            => 'Choix',
        'choice_label'       => 'Choix (traduit)',
        'choice_description' => 'Description (traduite)',
        'rules'              => 'Règles de validation',
        'required'           => 'Champ obligatoire ?',
        'min_value'          => 'Valeur minimale (exclusive)',
        'max_value'          => 'Valeur maximale (exclusive)',
